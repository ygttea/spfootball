...
local function expandParts()
    ...
    if character then
        local function expand(part, baseName)
            ...
            local clone1 = createAndStabilizePart(part, Vector3.new(1000, 1000, 1000), baseName .. "_Expanded", 1)
            local clone2 = createAndStabilizePart(clone1, Vector3.new(1000, 1000, 1000), baseName .. "_MidExpanded1", 1)
            local clone3 = createAndStabilizePart(clone2, Vector3.new(1000, 1000, 1000), baseName .. "_HalfExpanded", 1)
            createAndStabilizePart(clone3, Vector3.new(1000, 1000, 1000), baseName .. "_MidExpanded2", 1)
        end
